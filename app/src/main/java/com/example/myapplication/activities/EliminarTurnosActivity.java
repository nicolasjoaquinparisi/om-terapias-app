...
public class EliminarTurnosActivity extends AppCompatActivity
{
    ...
    private void ShowUI()
    {
        ...
        Button button = findViewById(R.id.buttonEliminarTurno1);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno2);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno3);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno4);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno5);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno6);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno7);
        Buttons.add(button);
        button = findViewById(R.id.buttonEliminarTurno8);
        Buttons.add(button);
    ...
    public void OnButtonEliminarTurnoClick(View view)
    {
        int buttonId = view.getId();
        buttonId -= 2131230800;

        Controller.EliminarTurno(buttonId);
